...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		editPropsItems: function(propsNode)
		{
			...
			var propsCommentContainer = BX.create('DIV', {props: {className: 'col-sm-6 block-right'}});
			propsNode.appendChild(propsCommentContainer);

			var propsItemsContainerThree = propsNode.querySelector('.col-sm-6.block-right'),
				div = BX.create('DIV', {
					props: {className: 'new-adrees'},
					children: propsNode
				});
			propsItemsContainerThree.appendChild(div);

			var propsItemsContainerFour = propsNode.querySelector('.col-sm-6.block-right'),
				div = BX.create('DIV', {
					props: {className: 'adrees-info'},
					children: propsNode
				});
			propsItemsContainerFour.appendChild(div);

			var propsItemsContainer = BX.create('DIV', {props: {className: 'col-sm-6 bx-soa-customer'}}),
			...
			while (group = groupIterator())
			{
				...
				while (property = propsIterator())
				{
					...
					{
						case '30':
							var propsItemsContainerTwo = propsNode.querySelector('.col-sm-6.block-right');
							this.getPropertyRowNode(property, propsItemsContainerTwo, false);
						break;

						case '43':
						case '44':
						case '45':
							propsItemsContainerThree = propsNode.querySelector('.new-adrees');
							this.getPropertyRowNode(property, propsItemsContainerThree, false);
						break;
						case '66':
						case '67':
							propsItemsContainerFour = propsNode.querySelector('.adrees-info');
							this.getPropertyRowNode(property, propsItemsContainerFour, false);
							break;
						default:
			...
			this.getZipLocationInput(propsItemsContainer);
		...
		getPropertyRowNode: function(property, propsItemsContainer, disabled)
		{
			...
			else
			{
				...
				{
					case '30':
						name = 'form-group bx-soa-customer-field order1';
					break;
					case '43':
						name = 'form-group bx-soa-customer-field street';
					break;
					default:
						name = 'form-group bx-soa-customer-field';
					break;
				}

				BX.addClass(propsItemNode, name);
		...
		editPropsComment: function(propsNode)
		{
			...
			propsCommentContainer = BX.create('DIV', {props: {className: 'col-sm-12 block-comment'}});
			//propsCommentContainer = propsNode.querySelector('.col-sm-6.block-right');
