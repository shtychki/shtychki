							...
							foreach($arResult["ITEMS"] as $key=>$arItem)
							{
								...
								<div class="bx_filter_parameters_box <?=$class;?> <?=(isset($arItem['PROPERTY_SET']) && $arItem['PROPERTY_SET'] == 'Y' ? ' set' : '');?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code=<?=strtolower($arItem["CODE"]);?> data-property_id="<?=$arItem["ID"]?>" data-property_name="<?=$arItem["NAME"]?>">
									...
									<?if(!$arItem["IS_PROP_INLINE"]){?>
												...
												<div class="char_name">
													<div class="props_list">
														<?if($arParams["SHOW_HINTS"]){
															...
															<?if( $arItem["FILTER_HINT"] && strpos( $arItem["FILTER_HINT"],'line')===false && $arItem["FILTER_HINT"] != 'search'){?>
                                        ...
                                        <?if($arItem["FILTER_HINT"] && strpos( $arItem["FILTER_HINT"],'search')!==false){?>
                                        <div class="filter_search">
                                            <input autocomplete="off" name="search-item" placeholder="<?=$arItem["NAME"]?>" data-id="<?=$arItem["ID"]?>" id="<?=$arItem["ID"]?>" class="search_inp_ajax" value="">
                                        </div>
                                        <?}?>
									<?}?>
									<?$style="";
									...
									<div class="bx_filter_block <?=(!$arItem["IS_PROP_INLINE"] && $arItem["DISPLAY_TYPE"] != 'A' ? '' : '');?> <?=(!$arItem["IS_PROP_INLINE"] && $arItem["PROPERTY_TYPE"]!="N" && ($arItem["DISPLAY_TYPE"] != "P" && $arItem["DISPLAY_TYPE"] != "R") ? "" : "");?>" <?=$style;?>>
										<div class="bx_filter_parameters_box_container <?=($arItem["DISPLAY_TYPE"]=="G" ? "pict_block" : "");?> box_<?=$arItem["ID"];?>">
										<?
...
//                                                echo '</pre>';
                                                $arItem["VALUES"] = sort_nested_arrays($arItem["VALUES"]);
//                                                $arItem["VALUES"] = customMultiSort($arItem["VALUES"], 'DISABLED');
...
<!--														<div class="hidden_values">-->
													...
													<input
														...
														onclick="smartFilter.click(this)"
													/>
													<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label <?=($isSize ? "nab sku" : "");?> <?=($i==$count ? "last" : "");?> <?= $ar["DISABLED"] ? 'disabled' : '' ?> filter-hidden <?= $isHidden ? '' : '--show' ?>" for="<? echo $ar["CONTROL_ID"] ?>" data-name="<?=$ar["VALUE"];?>">
														<span class="bx_filter_input_checkbox">
...
<!--													</div>-->
<!--													<div class="inner_expand_text"><span class="expand_block">--><?//=Loc::getMessage("FILTER_EXPAND_VALUES");?><!--</span></div>-->
                                                <div class="show_hidden_params">
                                                    <span class="expand_block show_all --active">
                                                        <?=Loc::getMessage("FILTER_EXPAND_VALUES");?>
                                                    </span>
                                                    <span class="expand_block hide_all">
                                                        <?=Loc::getMessage("FILTER_HIDE_VALUES");?>
                                                    </span>
                                                </div>
												<?endif;?>
										<?}?>
