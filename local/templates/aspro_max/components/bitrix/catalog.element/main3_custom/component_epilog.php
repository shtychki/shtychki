...
$APPLICATION->AddHeadString('<link rel="canonical" href="https://'.SITE_SERVER_NAME.$page.'" />',true);
...
//																	"XML_ID" => $templateData['XML_ID'].(isset($templateData['OFFERS_INFO']) && isset($templateData['OFFERS_INFO']['OFFERS']) && count($templateData['OFFERS_INFO']['OFFERS']) ? '%' : ''),
    ...
    <?//tabs mode?>
        ...
        if (is_array($arResult["SECTION"])) {
            ...
            if (isset($templateData['BREADCRUMB_FILTER_VALUE']) && !empty($templateData['BREADCRUMB_FILTER_VALUE'])) {
                $APPLICATION->AddChainItem($templateData['BREADCRUMB_FILTER_DESC'], '/catalog/'.$templateData['BREADCRUMB_FILTER_VALUE'].'/');
            }
