...
$templateData = array(
    ...
    'GENERAL_ID' => $arResult['PROPERTIES']['ID']['VALUE'],
    'BREADCRUMB_FILTER_VALUE' => $arResult['PROPERTIES']['BREADCRUMB_FILTER']['VALUE'],
    'BREADCRUMB_FILTER_DESC' => $arResult['PROPERTIES']['BREADCRUMB_FILTER']['DESCRIPTION'],
);
