...
<?
global $arTheme;
$iVisibleItemsMenu = ($arTheme['MAX_VISIBLE_ITEMS_MENU']['VALUE'] ? $arTheme['MAX_VISIBLE_ITEMS_MENU']['VALUE'] : 100);
$MENU_TYPE = 3;
$bManyItemsMenu = ($MENU_TYPE == '4' || $MENU_TYPE == '3');
$menu_class = ($MENU_TYPE == '4' || $MENU_TYPE == '3') ? 'menu-type-4' : 'menu-type-'.$MENU_TYPE;
					...
					<td class="menu-item <?=($arItem["CHILD"] ? "dropdown" : "")?> <?=(isset($arItem["PARAMS"]["CLASS"]) ? $arItem["PARAMS"]["CLASS"] : "");?>  <?=($arItem["SELECTED"] ? "active" : "")?>">
						<div class="wrap">
                            <?if(isset($arItem["PARAMS"]["CLASS"]) && strpos($arItem["PARAMS"]["CLASS"], "catalog") !== false):?>
                                <a class="<?=($arItem["CHILD"] && $bShowChilds ? "dropdown-toggle" : "")?>" <?if($arItem["LINK"] != "/catalog/"){?>href="<?=$arItem["LINK"]?>"<?}?>>
                                    <div class="catalog_wrap">
                                        <?if(isset($arItem["PARAMS"]["ICON"]) && $arItem["PARAMS"]["ICON"]):?>
                                            ...
                                            <i class="svg inline svg-inline-icon_catalog icon-open" aria-hidden="true">
                                            ...
                                            <i class="svg inline svg-inline-icon_catalog icon-close hide" aria-hidden="true">
                                                <svg class="" width="10" height="10" viewBox="0 0 10 10">
                                                    <path data-name="Rounded Rectangle 568 copy 16" class="cls-1" d="M1009.4,953l5.32,5.315a0.987,0.987,0,0,1,0,1.4,1,1,0,0,1-1.41,0L1008,954.4l-5.32,5.315a0.991,0.991,0,0,1-1.4-1.4L1006.6,953l-5.32-5.315a0.991,0.991,0,0,1,1.4-1.4l5.32,5.315,5.31-5.315a1,1,0,0,1,1.41,0,0.987,0.987,0,0,1,0,1.4Z" transform="translate(-1003 -948)"></path>
                                                </svg>
                                            </i>
                                        <?endif;?>
                                        <?=$arItem["TEXT"]?>
                            ...
                            <?else:?>
                                <a class="<?=($arItem["CHILD"] && $bShowChilds ? "dropdown-toggle" : "")?>" href="<?=$arItem["LINK"]?>">
                                    <div>
                                        <?if(isset($arItem["PARAMS"]["ICON"]) && $arItem["PARAMS"]["ICON"]):?>
                                            <?if(isset($arItem["PARAMS"]["CLASS"]) && strpos($arItem["PARAMS"]["CLASS"], "catalog") !== false):?>
                                                <span class="icon-open"><?=CMax::showIconSvg($arItem["PARAMS"]["ICON"], SITE_TEMPLATE_PATH.'/images/svg/'.$arItem["PARAMS"]["ICON"].'.svg', '', '');?></span>
                                                <span class="icon-close hide"><?=CMax::showIconSvg($arItem["PARAMS"]["ICON"], SITE_TEMPLATE_PATH.'/images/svg/Close.svg', '', '');?></span>
                                            <?else:?>
                                                <?=CMax::showIconSvg($arItem["PARAMS"]["ICON"], SITE_TEMPLATE_PATH.'/images/svg/'.$arItem["PARAMS"]["ICON"].'.svg', '', '');?>
                                            <?endif;?>
                                        <?endif;?>
							...
							<?if($arItem["CHILD"] && $bShowChilds):?>
								...
								<div class="dropdown-menu only-catalog <?=$bRightSide ? 'with_right_block' : ''?> <?=$arItem['bManyItemsMenu'] ? 'long-menu-items' : ''?> <?=$arTheme['SHOW_RIGHT_SIDE']['DEPENDENT_PARAMS']['RIGHT_CONTENT']['VALUE']?>">
									...
									<div class="customScrollbar <?=($bWideMenu ? 'scrollblock' : '');?>">
										...
										<ul class="menu-wrapper <?=$menu_class?>" >
