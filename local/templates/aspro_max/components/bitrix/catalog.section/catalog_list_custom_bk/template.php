						...
						<div class="description">
							...
							<?if($boolShowProductProps || $boolShowOfferProps):?>
								<?if($bNormalView):?>
										...
										<?if ($boolShowProductProps){
											foreach( $arItem["DISPLAY_PROPERTIES"] as $arProp ){?>
												<?if( !empty( $arProp["VALUE"] ) ){?>
													<div class="prod_div">
														<span class="char_name"><?=$arProp["NAME"]?>
															<?if($arProp["HINT"] && $arParams["SHOW_HINTS"]=="Y"):?>
																<span class="hint">
																	<span class="icon colored_theme_hover_bg"><i>?</i></span>
																	<span class="tooltip"><?=$arProp["HINT"]?></span>
																</span>
															<?endif;?>
														</span>
														<span>
									...
									<? //print_r($arItem['DISPLAY_PROPERTIES_NEW']);?>
									<div class="show_props">
										<span class="darken font_xs colored_theme_hover_text char_title opened"><?=CMax::showIconSvg("down", SITE_TEMPLATE_PATH.'/images/svg/arrow_catalogcloser.svg', '', '', true, false);?><span class=""><?=Loc::getMessage('PROPERTIES')?></span></span>
									</div>
								<?else:?>
