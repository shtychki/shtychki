		...
		$('form[name="<?=$arResult["arForm"]["VARNAME"]?>"]').validate({
			...
			submitHandler: function( form ){
				if( $('form[name="<?=$arResult["arForm"]["VARNAME"]?>"]').valid() ){
					...
					if(sid == 'ASK'){
                        dataLayer.push({'event': 'goal_ask_success'});
                    } else if(sid == 'SERVICES'){
                        dataLayer.push({'event': 'goal_services_success'});
                    } else if(sid == 'ASK_STAFF'){
                        dataLayer.push({'event': 'goal_ask_staff_success'});
                    } else if(sid == 'REVIEW'){
                        dataLayer.push({'event': 'goal_review_success'});
                    }
				}
			},
