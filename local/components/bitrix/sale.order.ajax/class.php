...
class SaleOrderAjax extends \CBitrixComponent
{
	...
	protected function registerAndLogIn($userProps)
	{
        ...
        $phoneUser = isset($userProps['PHONE']) ? $userProps['PHONE'] : '';
        $arUserByPhone = \Bitrix\Main\UserPhoneAuthTable::getRow([
            'select' => ['USER_ID'],
            'filter' => ['=PHONE_NUMBER' => $phoneUser],
        ]);
        ...
        if(!$arUserByPhone) {
            ...
            $addResult = $arUserByPhone['USER_ID'];
        }
