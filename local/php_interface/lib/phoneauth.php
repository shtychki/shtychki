        ...
        if($bByPhoneRequest){
            ...
            if(!$bCaptchaError){
                ...
                if($arUser === false){
                        ...
                        $arUser['USER_ID'] = $newUser->Add($arUserFields);
                        $arResult['PROFILE_URL'] = '/personal/private/';
                }
                ...
                if($bByPhoneSMSCodeRequest){
                    ...
                    // verify sms code
//                    \Bitrix\Main\Diag\Debug::writeToFile(array('add', date('Y.m.d H:i:s'), '$arParams', $arParams, '$_POST', $_POST), null, '/local/auth_log.php');
...
//                        \Bitrix\Main\Diag\Debug::writeToFile(array('add sms event', date('Y.m.d H:i:s'), '$arParams', $arParams, '$_POST', $_POST), null, '/local/auth_log.php');
                        // add sms event
                        $et = new \CEventType;
                        $arEventFields = array(
                            'LID' => LANGUAGE_ID,
...
//                        \Bitrix\Main\Diag\Debug::writeToFile(array('check sms template exist', date('Y.m.d H:i:s'), '$arParams', $arParams, '$_POST', $_POST), null, '/local/auth_log.php');
                    ...
                    if($bSend){
                        // send sms
//                        \Bitrix\Main\Diag\Debug::writeToFile(array('send sms', date('Y.m.d H:i:s'), '$arParams', $arParams, '$_POST', $_POST, '$arResult', $arResult), null, '/local/auth_log.php');
