...
$APPLICATION->SetPageProperty("description", "Узнайте как оформить заказ в интернет магазине shtychki.by");
$APPLICATION->SetPageProperty("title", "Как оформить заказ в shtychki.by");
